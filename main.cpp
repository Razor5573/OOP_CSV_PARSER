...
int main(int argc, char *argv[]) {
    ...
    CSVParser::CSVTupleParser<int, std::string, double, double, std::string> parser(inputFileStream, handler.getLinesToSkipNumber(), handler.getCsvDelimiter(), handler.getCsvEscapeSymbol());
    try {
        for (auto &it : parser) {
