#ifndef CSV_Parcer4_CSVTUPLEPARSER_H
#define CSV_Parcer4_CSVTUPLEPARSER_H
...
namespace CSVParser {
    ...
    public:
        CSVTupleParser(std::ifstream &inputStream, const size_t skipLinesNumber, const char delimiter, const char screenedSymbol) :
        ...
        public:
            ...
            iterator(std::ifstream &itInputStream, const unsigned int row, const char delimiter, const char screenedSymbol, const std::streampos streamPosition) :
...
#endif //CSV_Parcer4_CSVTUPLEPARSER_H
